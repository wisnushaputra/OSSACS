...
async function seed() {
    ...
    try {
        ...
        const defaultProfiles = [
            { name: 'Line Profile - Basic', type: 'line', description: 'Basic line profile' },
            { name: 'Service Profile - Internet', type: 'service', description: 'Internet service profile' },
            { name: 'DBA Profile - Standard', type: 'dba', description: 'Standard DBA profile' },
            { name: 'VLAN Profile - Default', type: 'vlan', description: 'Default VLAN profile' },
        ];
